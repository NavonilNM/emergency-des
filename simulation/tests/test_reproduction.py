...
def test_reproduction():
    ...
    exp_patient = pd.read_csv(
        Path(__file__).parent.joinpath("../tests_resources/python_patient.csv")
    )
    exp_run = pd.read_csv(
        Path(__file__).parent.joinpath("../tests_resources/python_run.csv")
    )
    exp_overall = pd.read_csv(
        Path(__file__).parent.joinpath("../tests_resources/python_overall.csv")
    )
