...
from simulation.simulationStroke.logging import SimLogger
...
class ASUArrivals(RestrictAttributes):
    ...
    def __repr__(self):
        return (f"RehabArrivals(stroke={self.stroke}, tia={self.tia}, " +
                f"neuro={self.neuro}, other={self.other})")
...
class RehabArrivals(RestrictAttributes):
    ...
    def __repr__(self):
        return (f"RehabArrivals(stroke={self.stroke}, "
                f"neuro={self.neuro}, other={self.other})")
...
class ASULOS(RestrictAttributes):
    ...
    def __repr__(self):
        return (f"ASULOS(stroke_noesd={self.stroke_noesd}, " +
                f"stroke_esd={self.stroke_esd}, " +
                f"stroke_mortality={self.stroke_mortality}, " +
                f"tia={self.tia}, neuro={self.neuro}, other={self.other})")
...
class RehabLOS(RestrictAttributes):
    ...
    def __repr__(self):
        return (f"RehabLOS(stroke_noesd={self.stroke_noesd}, " +
                f"stroke_esd={self.stroke_esd}, tia={self.tia}, " +
                f"neuro={self.neuro}, other={self.other})")
...
class ASURouting(RestrictAttributes):
    ...
    def __repr__(self):
        return (f"ASURouting(stroke={self.stroke}, tia={self.tia}, " +
                f"neuro={self.neuro}, other={self.other})")
